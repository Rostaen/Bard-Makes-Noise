...
<style>
	...
	<div class="row lt-gray">
		<div class="col-lg-8">
			...
			<p>
				<ul>
					<li>Mike Rorro (class of '89): Fretless electric Kramer aluminum bass</li>
					<li>Larry Lefever (class of '87): Drums and percussion</li>
					<li>Harold Lehman (class of '87): Electric guitar, feedback and electronic effects</li>
				</ul>
			</p>
			<!-- <h2>From Harold Lehman:</h2>
			<p>
			...
			<p>
				<a href="#" data-toggle="modal" data-target="#haroldBlerb">Read more from Harold about Three Beasts in Heat.</a>
			</p>
			<h2>From Dan McBride:</h2>
			<p>
				You have far more granular memory of this time than I do. I could remember it as you were telling it, but in my mind it is more locked in a long ago and far away compartment. Your recall of things is so much better than mine that I don't really have much to add--except for one story.
			</p>
			<p>
				On the night of an important recital for Harold's senior project at Bard Hall, I was to join Three Beasts for Flightback, playing the same E minor rhythm guitar riffs that are still a part of my repertoire of guitar tricks to this day. It was one continuous performance, so I would have to jump in while the band was still wailing. It being Bard, I had taken LSD that day, assuming that I would be fine by the time of the performance. Or that it wouldn't really matter if I wasn't, which is what turned out to be the case--I was bonkers high. During the set that would end with Flightback, Mike broke a string on his bass, which caused the neck to relax, egregiously detuning the remaining three strings. As I plugged in my guitar and began to play, I was somehow not in the same key as the band--in fact the entire sonic universe seemed to have become unmoored from any laws of harmony that would allow me to find a place in it. Suddenly Harold's face appeared within my narrow window of perception, looking demented, like that of a tortured soul undergoing the agonies of eternal punishment in a dark bolgia of Inferno. Struggling to be heard over the din, he spoke a line that I recollect as pregnant with poignant meaning, a line that I have in fact recalled several time in the past few years as our society seems to have wobbled off it's axis under the pressures of imminent last days: "The song is in Eb now."
			</p>
			<h2>From Larry LeFever:</h2>
			<p>
				Mike starts something out of the blue, something funky as fuck. I join in. Harold's not there yet. Mike and I jam out on this thing he's come up with, just bass and drums. We finish, having turned it around and upside-down, every which way we could think of, without saying a word. I say, "Mike, what the fuck was that?" Mike says, "I based it on something I remember my sister playing on violin when we were kids."
			</p>
			<p>
				Harold arrives, sets up, says to Mike, "What key you wanna play in?" Mike says, "Doesn't matter. Just start. I'll pick it up."
			</p>
			<p>
				And we're off, just like that. And, yes, it does feel, in our best moments, more than a little like flying.
			</p>
			<p>
				About thirty minutes later, we come back out of our shared dreamlike state, laugh a little about this thing we somehow do together, without planning it, without writing it out, without talking it out, first, coming out of something we tacitly share, something more specific than human being.
			</p>
			<p>
				"That was cool."				
			</p>
			...
			<p>
				Forty-four years later, I remember it. I remember Mike, Harold and myself jamming, back at Bard, discovering things together, through art and our respective instruments, things it's as if we somehow knew were already there.
			</p>
			<p>
				And we were jamming in a church without a god.
			</p> -->
		</div>
		<div class="col-lg-4 pb-3">
			<div class="pb-3">
				...
				<div class="pb-3">
					<h3>Fast Funk</h3>
					<p>Recorded live to cassette by Gary Mosca and Matt Hill in Bard Music Studio February 26, 1987</p>
					<div style="width: 100%; height: 100px; position: relative;">
						<iframe
							...
							height="100"
							title="Band MP3"
							src="https://drive.google.com/file/d/1-szKEDvQBjW3-QM7BfBG3yDuPsspRS7-/preview?usp=sharing">
						</iframe>
				...
				<div class="pb-3">
					<h3>Flight Back</h3>
					<p>Live in Bard Hall December 6, 1986</p>
					<div style="width: 100%; height: 100px; position: relative;">
						<iframe
							frameborder="0"
							width="100%"
							height="100"
							title="Band MP3"
							src="https://drive.google.com/file/d/18KI4fxe-5Qa06qW2VWjk-cvdTa9AltoE/preview?usp=sharing">
						</iframe>
						<div style="width: 53px; height: 55px; position: absolute; opacity: 0; right: 0px; top: 0px;">&nbsp;</div>
					</div>
				</div>
				<div class="mb-3">
					<iframe width="100%" height="150" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/90617247&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe><div style="font-size: 10px; color: #cccccc;line-break: anywhere;word-break: normal;overflow: hidden;white-space: nowrap;text-overflow: ellipsis; font-family: Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif;font-weight: 100;"><a href="https://soundcloud.com/three-beasts-in-heat" title="Three Beasts In Heat" target="_blank" style="color: #cccccc; text-decoration: none;">Three Beasts In Heat</a> · <a href="https://soundcloud.com/three-beasts-in-heat/3-22-1987-sottery-hall-live" title="3.22.1987-Sottery Hall - live gig for Amnesty Intl *monophonic lo-fi version*" target="_blank" style="color: #cccccc; text-decoration: none;">3.22.1987-Sottery Hall - live gig for Amnesty Intl *monophonic lo-fi version*</a></div>
				</div>
				<div class="mb-3">
					<iframe width="100%" height="150" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/207090563&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe><div style="font-size: 10px; color: #cccccc;line-break: anywhere;word-break: normal;overflow: hidden;white-space: nowrap;text-overflow: ellipsis; font-family: Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif;font-weight: 100;"><a href="https://soundcloud.com/three-beasts-in-heat" title="Three Beasts In Heat" target="_blank" style="color: #cccccc; text-decoration: none;">Three Beasts In Heat</a> · <a href="https://soundcloud.com/three-beasts-in-heat/flight-back-december-6th-1986" title="Flight Back - (December 6th 1986)" target="_blank" style="color: #cccccc; text-decoration: none;">Flight Back - (December 6th 1986)</a></div>
				</div>
				<div class="mb-3">
					<iframe width="100%" height="150" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/90359413&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe><div style="font-size: 10px; color: #cccccc;line-break: anywhere;word-break: normal;overflow: hidden;white-space: nowrap;text-overflow: ellipsis; font-family: Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif;font-weight: 100;"><a href="https://soundcloud.com/three-beasts-in-heat" title="Three Beasts In Heat" target="_blank" style="color: #cccccc; text-decoration: none;">Three Beasts In Heat</a> · <a href="https://soundcloud.com/three-beasts-in-heat/ballad-of-three-beasts" title="(The Ballad of...) Three Beasts In Heat *monophonic lo-fi version* (February 26 1987 - Bard Music Studio)" target="_blank" style="color: #cccccc; text-decoration: none;">(The Ballad of...) Three Beasts In Heat *monophonic lo-fi version* (February 26 1987 - Bard Music Studio)</a></div>
				</div>
				<div class="pb-3">
					<h3>More on Sound Cloud</h3>
					<p>
						<a href="https://soundcloud.com/three-beasts-in-heat" target="_blank">Three Beasts in Heat on Sound Cloud</a>
					</p>
				</div>
			</div>
			<div>
				...
				<div id="bigNoiseSlider" class="carousel" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="https://www.bard.edu/bardmakesnoise/images/3bih/3bihRoof1.png" class="float-end ps-3 pb-3" alt="3 Beasts in Heat on the roof of Robbins" data-toggle="modal" data-target="#lsImg1">
						</div>
						<div class="carousel-item">
							<img src="https://www.bard.edu/bardmakesnoise/images/3bih/3bihRoof2.jpg" alt="3 Beasts in Heat on the roof of Robbins" data-toggle="modal" data-target="#lsImg2">
						</div>
					</div>
		...
		<div class="modal-dialog-mod">
			<div class="modal-content">
				...
				<div class="modal-header">
					<h4 class="modal-title">3 Beasts in Heat on the roof of Robbins</h4>
					<button type="button" class="close" data-dismiss="modal">&times;</button>
				</div>
				<!-- Modal body -->
				<div class="modal-body d-flex justify-content-center">
					<img src="https://www.bard.edu/bardmakesnoise/images/3bih/3bihRoof1.png" class="img-fluid" alt="3 Beasts in Heat on the roof of Robbins" data-toggle="modal" data-target="#lsImg1">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal" id="lsImg2">
		<div class="modal-dialog-mod">
			<div class="modal-content">
				...
				<!-- Modal body -->
				<div class="modal-body d-flex justify-content-center">
					<img src="https://www.bard.edu/bardmakesnoise/images/3bih/3bihRoof2.jpg" alt="3 Beasts in Heat on the roof of Robbins" data-toggle="modal" data-target="#lsImg2" style="width: 75%;">
				</div>
			</div>
		</div>
	</div>

	<div class="modal" id="haroldBlerb">
		<div class="modal-dialog-mod modal-dialog-block">
			<div class="modal-content">
				<!-- Modal Header -->
				<div class="modal-header">
					<h4 class="modal-title">From Harold Lehman</h4>
					<button type="button" class="close" data-dismiss="modal">&times;</button>
				</div>
				<!-- Modal body -->
