...
<div class="row lt-gray">
	...
	<aside class="col-lg-4 pb-3">
		...
		$musicData = [
			["What a Way to Go", "https://drive.google.com/file/d/1Tn4enUjQM8EWhTewnz4rzs-uVfUkVJKA/preview?usp=sharing", "The Appletree Theater from Playback"],
			["Subterranean Homsick Blues", "https://drive.google.com/file/d/1GGD8F5DdSZz1bsKFnOlNkfQMIJ3DhLGJ/preview?usp=sharing", "from Alias Boona featuring Donald Fagen and Walter Becker"],
		];
		displayMusic($musicData, 1);

		// Displaying Indicators, Images, and Controls
		$carouselData = [
			["tboylan/Gingermen1.JPG", "The Ginger Men"],
			["tboylan/Gingermen2.JPG", "The Ginger Men outside the Night Owl cafe 1"],
			["tboylan/Gingermen3.JPG", "The Ginger Men outside the Night Owl cafe 2"],
			["tboylan/appletreetheater.jpg", "Appletree Theatre Poster"],
			["tboylan/aliasboona.jpg", "Alias Boona album cover"],
		];
...
$modalData = [
	["The Ginger Men", "tboylan/Gingermen1.JPG", "The Ginger Men"],
	["The Ginger Men outside the Night Owl cafe 1", "tboylan/Gingermen2.JPG", "The Ginger Men outside the Night Owl cafe 1"],
	["The Ginger Men outside the Night Owl cafe 2", "tboylan/Gingermen3.JPG", "The Ginger Men outside the Night Owl cafe 2"],
	["Appletree Theatre Poster", "tboylan/appletreetheater.jpg", "Appletree Theatre Poster"],
	["Alias Boona album cover", "tboylan/aliasboona.jpg", "Alias Boona album cover"],
	["Terence Boylan in front of Stone Row", "tboylan/tboylan.jpg", "Terence Boylan in front of Stone Row"],
];
